...
- Shaohua(Teresa) Liu: Firebase setup and CRUD operations, navigation stack structures, Authetication, Notification use, Location Use and Weather API, Chat Function, Camera Use and User Profile Form, PostForm, User Booking and Post History Page; 
